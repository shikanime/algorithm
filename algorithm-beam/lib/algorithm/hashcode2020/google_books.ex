defmodule Algorithm.HashCode2020.GoogleBooks.Solver do
  require Logger
  ...
  # TODO: this function is not usable
...
defmodule Algorithm.HashCode2020.GoogleBooks.IO do
...
defmodule Algorithm.HashCode2020.GoogleBooks do
  alias Algorithm.HashCode2020.GoogleBooks, as: S

  def run do
    {n_books, n_libraries, budget} = S.IO.read_header(:stdio)
    _order = S.IO.read_books(:stdio, n_books)
    libraries = S.IO.read_libraries(:stdio, n_libraries)
    libraries = S.Solver.solve(budget, libraries)
    S.IO.put_libraries(:stdio, libraries)
  end
end
