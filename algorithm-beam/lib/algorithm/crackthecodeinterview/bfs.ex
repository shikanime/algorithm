...
defmodule Algorithm.CrackTheCodeInterview.BFS do
...
defmodule Algorithm.CrackTheCodeInterview.BFS.Data do
  def read do
...
defmodule Algorithm.CrackTheCodeInterview.BFS.Solver do
  def solve do
    Algorithm.CrackTheCodeInterview.BFS.Data.read() |> Algorithm.CrackTheCodeInterview.BFS.bfs(1)
  end
end
